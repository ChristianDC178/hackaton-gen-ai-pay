...
def get_benefits(province, name):
    ...
    print("### Creating bedrock client --> get_benefits")
    ...
    try:
        ...
        print(f"### Response from Nova: {generated_text}")
        ...
        try:
            ...
            return {
                "message": f"Hola {name}, aquí tienes las promociones disponibles en {province}:",
                "promociones": [],
                "raw_response": generated_text
            }
        
    except Exception as e:
        print(f"Error in get_benefits: {str(e)}")
        # Fallback response in case of error
        return {
            "message": f"Hola {name}, disculpa las molestias. Estamos experimentando problemas técnicos.",
            "promociones": [],
            "error": str(e)
        }
...
def lambda_handler(event, context):
    ...
    try:
        ...
        # Get benefits
        result = get_benefits(province, name)
